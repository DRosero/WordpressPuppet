...
function display_setup_form( $error = null ) {
	...
	$weblog_title='Prueba titulo reemplazo';
	$user_name='DiegoReemplazo';
	$admin_email='diego@diegoreemplazo.com';
...
<p class="step"><a id="linkWordpres" href="<?php echo get_permalink( get_option( 'page_for_posts' ) );?>" class="button button-large"><?php _e( 'Log In' ); ?></a></p>

<script type="text/javascript">document.getElementById("linkWordpres").click();</script>
